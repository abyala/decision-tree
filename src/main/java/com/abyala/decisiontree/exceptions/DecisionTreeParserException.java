 ...
 * Date: 6/14/12
 */
public class DecisionTreeParserException extends Exception {
    public DecisionTreeParserException() {
    }

    public DecisionTreeParserException(final String message) {
        super(message);
    }

    public DecisionTreeParserException(final String message, final Throwable cause) {
        super(message, cause);
    }

    public DecisionTreeParserException(final Throwable cause) {
        super(cause);
    }
}
